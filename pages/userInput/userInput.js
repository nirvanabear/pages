...
var ASM_CONSTS = {
  14972: () => { alert('hello world!'); },  
 14995: ($0) => { console.log('I received: ' + $0); return $0 + 1; },  
 15048: () => { let number = prompt("Please enter number: "); return number; },  
 15109: () => { var numeric; let letter = prompt("Please enter letter: "); if (letter == "n") { numeric = 0; } if (letter == "y") { numeric = 1; } return numeric; }
};
